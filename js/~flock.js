        ...
        t.register("iM5Ye", function (e, i) {
            ...
            class m {
                ...
                h(a) {
                    ...
                    e &&
                    i &&
                    a.startTime - i.startTime < 1e3 &&
                    a.startTime - e.startTime < 5e3
                        ? ((this.i += a.value), this.o.push(a))
                        : ((this.i = a.value), (this.o = [a])),
                        this.t?.(a));
                }
            }
            const d = (a, e, i = {}) => {
                    try {
                        if (
                            PerformanceObserver.supportedEntryTypes.includes(a)
                        ) {
            ...
            const f = () =>
                ...
                h = (a) => {
                    "hidden" === document.visibilityState &&
                        g > -1 &&
                        ((g = "visibilitychange" === a.type ? a.timeStamp : 0),
                        v());
                },
                S = () => {
                ...
                h(a) {
                    ...
                    if (i || this.u.length < 10 || a.duration > e.T) {
                        if (
                            (i
                                ? a.duration > i.T
                                    ? ((i.entries = [a]), (i.T = a.duration))
                                    : a.duration === i.T &&
                                      a.startTime === i.entries[0].startTime &&
                                      i.entries.push(a)
                                : ((i = {
                                      id: a.interactionId,
                                      entries: [a],
            ...
            const D = [2500, 4e3],
                ...
                H = (a, e = {}) => {
                    ...
                    x(() => {
                        const o = c();
                        o &&
                            ((i.value = Math.max(o.responseStart - s(), 0)),
                            (i.entries = [o]),
                            r(!0),
                            t(() => {
                                ((i = A("TTFB", 0)),
        ...
        (function () {
            ...
            if (document.currentScript) {
                if (
                    ...
                    throw (
                        console.error(
                            "Error: Both data-proxy and data-proxy-url are specified. Please use only one of them.",
                        ),
                        new Error(
                            "Both data-proxy and data-proxy-url are specified. Please use only one of them.",
                        )
                    );
                ((i =
                ...
                for (const E of document.currentScript.attributes)
                    (E.name.startsWith("tb_") &&
                        (l[E.name.slice(3).replace(/-/g, "_")] = E.value),
                        E.name.startsWith("data-tb-") &&
                            (l[E.name.slice(8).replace(/-/g, "_")] = E.value));
            }
            var d = null;
            function p() {
            ...
            function f() {
                const a = g() || p();
                if ([r.localStorage, r.sessionStorage].includes(u)) {
                    const i = { value: a, expiry: new Date().getTime() + 18e5 },
                        t = JSON.stringify(i),
                        n =
                            u === r.localStorage
                                ? localStorage
            ...
            function h(a) {
                return (
                    !(!a || "string" != typeof a) &&
                    !(a.length < 2 || a.length > 10240)
                );
            }
            !document.currentScript ||
                ("true" !== document.currentScript.getAttribute("web-vitals") &&
                    "true" !==
                        document.currentScript.getAttribute(
                            "data-web-vitals",
                        )) ||
